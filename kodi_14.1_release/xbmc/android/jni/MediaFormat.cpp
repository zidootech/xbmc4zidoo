...
std::string CJNIMediaFormat::KEY_PUSH_BLANK_BUFFERS_ON_STOP;
...
void CJNIMediaFormat::PopulateStaticFields()
{
  if(GetSDKVersion() >= 16)
  {
	...
	KEY_PUSH_BLANK_BUFFERS_ON_STOP = jcast<std::string>(get_static_field<jhstring>(clazz, "KEY_PUSH_BLANK_BUFFERS_ON_STOP"));
  }
}
