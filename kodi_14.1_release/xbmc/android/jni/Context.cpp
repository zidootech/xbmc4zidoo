...
jhobject CJNIContext::m_SurfaceViewHolder(0);
...
void CJNIContext::_SetVideoPlayViewHolder(JNIEnv *env, jobject context, jobject holder)
{
	(void)env;
  	(void)context;	
	m_SurfaceViewHolder = jhobject(holder);
	m_SurfaceViewHolder.setGlobal();
}
jni::jhobject CJNIContext::getSurfaceViewHolder()
{
	return m_SurfaceViewHolder;
}
